...
import {AiOutlineMail, AiFillGithub, AiFillLinkedin, AiOutlineFilePdf} from 'react-icons/ai'
    ...
    <div className='hidden lg:flex flex-col top-[35%] left-0 fixed'>
        <ul>
            ...
            {links.map(link => (
                ...
                <a href={link.link} target="_blank" rel="noreferrer" className='flex justify-between items-center w-full text-white'>
                    <>
                     {link.id} {link.icon}
                    </>
                </a>
